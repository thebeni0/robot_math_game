...
const chapters = [
  ...
  },
  {
    ...
    levels: [
      { scene: "Count the toolkits", question: "25 + 13 = ?", choices: [38, 37, 39], correctAnswer: 38, successMessage: "Toolkits counted!" },
      { scene: "Bolt loss update", question: "42 - 17 = ?", choices: [25, 26, 24], correctAnswer: 25, successMessage: "Bolts updated!" },
      { scene: "Tally screws from bins", question: "16 + 14 = ?", choices: [30, 31, 29], correctAnswer: 30, successMessage: "Screws totaled!" },
      { scene: "Widget delivery update", question: "36 + 28 = ?", choices: [64, 65, 63], correctAnswer: 64, successMessage: "Widgets loaded!" },
      { scene: "Rivet usage update", question: "60 - 20 = ?", choices: [40, 39, 41], correctAnswer: 40, successMessage: "Rivets remaining!" },
      { scene: "Count total kits", question: "3 × 12 = ?", choices: [36, 35, 37], correctAnswer: 36, successMessage: "Kits counted!" },
      { scene: "Tool bin check", question: "15 × 5 = ?", choices: [75, 74, 76], correctAnswer: 75, successMessage: "Inventory tallied!" },
      { scene: "Check remaining wires", question: "40 - 17 = ?", choices: [23, 22, 24], correctAnswer: 23, successMessage: "Wires left noted!" },
      { scene: "Gadget inventory update", question: "8 + 6 = ?", choices: [14, 13, 15], correctAnswer: 14, successMessage: "Gadget count updated!" },
      { scene: "Update collected widgets", question: "90 - 45 = ?", choices: [45, 44, 46], correctAnswer: 45, successMessage: "Belt cleared!" }
    ]
  },
  {
    ...
    levels: [
      { scene: "Glitchbot 1 approaching", question: "What is 6 × 8?", choices: [48, 47, 49], correctAnswer: 48, successMessage: "Bot deactivated!" },
      { scene: "Glitchbot 2 attacking", question: "What is 7 × 4?", choices: [28, 27, 29], correctAnswer: 28, successMessage: "Stabilized!" },
      { scene: "Glitchbot 3 charging up", question: "What is 9 × 3?", choices: [27, 28, 26], correctAnswer: 27, successMessage: "Bot neutralized!" },
      { scene: "Glitchbot 4 reactivated", question: "What is 5 × 5?", choices: [25, 26, 24], correctAnswer: 25, successMessage: "Bot rebooted!" },
      { scene: "Glitchbot 5 attacking fast", question: "What is 3 × 9?", choices: [27, 26, 28], correctAnswer: 27, successMessage: "Stunned!" },
      { scene: "Glitchbot 6 shutting down", question: "What is 8 × 6?", choices: [48, 47, 49], correctAnswer: 48, successMessage: "Bot disabled!" },
      { scene: "Glitchbot 7 detected", question: "What is 2 × 7?", choices: [14, 13, 15], correctAnswer: 14, successMessage: "Cleared!" },
      { scene: "Glitchbot 8 preparing attack", question: "What is 4 × 4?", choices: [16, 15, 17], correctAnswer: 16, successMessage: "Bot offline!" },
      { scene: "Glitchbot 9 blocking path", question: "What is 10 × 3?", choices: [30, 31, 29], correctAnswer: 30, successMessage: "Down!" },
      { scene: "Glitchbot 10 final battle", question: "What is 7 × 6?", choices: [42, 41, 43], correctAnswer: 42, successMessage: "Battle won!" }
    ]
  },
  {
    ...
    levels: [
      { scene: "Pattern panel 1 unlocked", question: "What fits? 2, 4, 6, ?, 10", choices: [8, 7, 9], correctAnswer: 8, successMessage: "Panel unlocked!" },
      { scene: "Pattern panel 2 flashing", question: "What fits? 5, 10, ?, 20", choices: [15, 14, 16], correctAnswer: 15, successMessage: "Code accepted!" },
      { scene: "Pattern panel 3 active", question: "What fits? 3, 6, 9, ?, 15", choices: [12, 11, 13], correctAnswer: 12, successMessage: "Matched!" },
      { scene: "Binary pattern detected", question: "What fits? 1, 2, 4, 8, ?", choices: [16, 15, 17], correctAnswer: 16, successMessage: "Sequence synced!" },
      { scene: "Geometric sequence triggered", question: "What fits? 7, 14, ?, 28", choices: [21, 20, 22], correctAnswer: 21, successMessage: "Logic complete!" },
      { scene: "Panel matrix scramble", question: "What fits? 9, 18, ?, 36", choices: [27, 26, 28], correctAnswer: 27, successMessage: "Access granted!" },
      { scene: "Triangular pattern recognized", question: "What fits? 1, 3, 6, 10, ?", choices: [15, 14, 13], correctAnswer: 15, successMessage: "Panel open!" },
      { scene: "Decade pattern sequence", question: "What fits? 10, 20, ?, 40", choices: [30, 29, 31], correctAnswer: 30, successMessage: "Unlocked!" },
      { scene: "Four-step increase pattern", question: "What fits? 4, 8, 12, ?, 20", choices: [16, 15, 17], correctAnswer: 16, successMessage: "Key accepted!" },
      { scene: "Code sequence final check", question: "What fits? 13, 26, 39, ?, 65", choices: [52, 50, 54], correctAnswer: 52, successMessage: "Final door opened!" }
    ]
  },
  {
    name: "Robo Reunion",
